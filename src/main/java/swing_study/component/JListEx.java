...
public class JListEx extends JFrame implements ActionListener {
	...
	private String[] fruits = new String[] {"apple", "banana", "kiwi", "mango", 
	...
	protected void actionPerformedBtn01(ActionEvent e) {
		...
		String message = String.format("index : %d%nselectedValue : %s%nselectedList : %s", 
